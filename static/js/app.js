/**
 * AETHER AI • Client Application Core
...
function exportCurrentChat() {
  ...
  mdContent += `*Generated by Aether AI • Persona: ${chat.persona} • ${new Date(chat.createdAt).toLocaleString()}*\n\n---\n\n`;

  chat.messages.forEach(msg => {
    const sender = msg.role === "user" ? "🧑 You" : "🤖 Aether AI";
  ...
  a.href = url;
  a.download = `Aether_Chat_${Date.now()}.md`;
  a.click();
